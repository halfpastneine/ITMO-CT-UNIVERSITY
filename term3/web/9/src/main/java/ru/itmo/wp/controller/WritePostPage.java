...
public class WritePostPage extends Page {
    ...
    public String writePostPost(@Valid @ModelAttribute("postCredentials") PostCredentials post,
        ...
        userService.writePost(getUser(httpSession), postService.makePost(post));
