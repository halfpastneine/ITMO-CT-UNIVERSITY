...
class HttpServer {
    ...
    private void process(Request request, Response response) throws IOException {
        ...
        String s = URLDecoder.decode(request.getUri(), StandardCharsets.UTF_8.name());
        ...
        if (file.isFile()) {
            ...
            if (Objects.equals(String.valueOf(Arrays.hashCode(body)), request.getHeader("If-None-Match"))) {
